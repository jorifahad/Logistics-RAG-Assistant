...
# =========================================================
# IMPORT YOUR NEW QUERY FILE
# =========================================================

from query_result3 import query_rag
...
# =========================================================
# LOAD API KEY FROM query_result3.py
# =========================================================

def get_api_key():

    text = Path("query_result3.py").read_text(encoding="utf-8")
...
def main():
    ...
    evaluation_data = evaluation_data[:MAX_QUESTIONS]
    ...
    with open("ragas_results3.txt", "w", encoding="utf-8") as f:

        f.write(str(result))

    print("\nSaved results to:")
    print("ragas_results3.txt")
